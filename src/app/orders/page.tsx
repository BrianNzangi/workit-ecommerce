...
export default function OrdersPage() {
  ...
  if (loading) {
    return (
      <main className="min-h-[70vh] flex items-center justify-center font-[DM_SANS]">
        <div className="text-center">
          <Package className="animate-pulse text-gray-400 mb-4" size={64} />
  ...
  return (
    <main className="min-h-[70vh] font-[DM_SANS] px-4 py-8">
