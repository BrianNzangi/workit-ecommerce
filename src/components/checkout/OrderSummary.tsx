...
export default function OrderSummary({
  ...
  return (
    <div className="bg-gray-100 rounded-xs border border-gray-200 p-6 space-y-4 font-[DM_SANS]">
      ...
      <div className="space-y-4">
        {cart.items.map((item) => (
          <div key={item.lineId} className="relative border border-gray-200 rounded-xs p-4">
            {/* Remove Button */}
            <button
            ...
            <div className="flex gap-4">
              {/* Product Image */}
              <div className="relative w-20 h-20 flex-shrink-0 bg-gray-100 rounded-xs overflow-hidden">
                {item.image ? (
                  <Image
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start gap-2">
                  <button className="mt-1 text-gray-400 hover:text-red-500">
                    <Heart size={16} />
                  </button>
