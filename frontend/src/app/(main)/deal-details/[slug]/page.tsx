...
import ProductRecommendationsLoading from '@/components/product/recommendations/ProductRecommendationsLoading';
import ProductRecommendationsServer from '@/components/product/recommendations/ProductRecommendationsServer';
    ...
    if (!productResponse.ok) {
      ...
      <SectionContainer className="px-6 sm:px-8 lg:px-16 py-10 text-center">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Product not found</h1>
          ...
          <Link
            href="/"
            className="inline-block bg-primary-900 text-white px-6 py-2 rounded-md hover:bg-primary-800 transition"
          >
            Back to Home
          </Link>
        </SectionContainer>
