...
import CollectionProducts from '@/components/shop/collections/CollectionProducts'
    ...
    if (collection) {
      ...
      return {
        ...
        openGraph: {
          title,
          description,
          url: `${SITE_CONFIG.url}/shop/collections/${lastSlug}`,
...
export default async function CollectionPage({ params }: Props) {
  ...
  const brands: Brand[] = []
  recordSsrRenderTime('/shop/collections/[...slug]', Date.now() - startedAt);
