...
export const paymentStateEnum = pgEnum("PaymentState", [
  "PENDING",
  "AUTHORIZED",
  "SETTLED",
  "DECLINED",
...
export const bannerPositionEnum = pgEnum("BannerPosition", [
  "HERO",
  "DEALS",
  "DEALS_HORIZONTAL",
  "MIDDLE",
...
export const automationTypeEnum = pgEnum("AutomationType", [
  "ABANDONED_CHECKOUT",
  "ABANDONED_CART",
  "ABANDONED_BROWSE",
  "WELCOME_SUBSCRIBER",
