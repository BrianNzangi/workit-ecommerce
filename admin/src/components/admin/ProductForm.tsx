                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            onChange={(e) => {
                                                const isInclusive = e.target.value === 'inclusive';
                                                setFormData(prev => ({
                                                    ...prev,
                                            ...
                                            className="w-full px-4 py-2 border border-gray-300 rounded-xs focus:ring-2 focus:ring-primary-600 focus:border-transparent appearance-none"
                                        >
                                            <option value="inclusive">Price is inclusive of {taxSettings.tax_name}</option>
                                            <option value="exclusive">Include {taxSettings.tax_name} ({taxSettings.default_tax_rate}%)</option>
                                        </select>
                                        <ChevronDown className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 pointer-events-none" />
                                    </div>
                                    <p className="mt-1 text-xs text-gray-500">Specify tax treatment for this product</p>
                                </div>
