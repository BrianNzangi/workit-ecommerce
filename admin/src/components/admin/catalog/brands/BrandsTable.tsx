        ...
        <Card className="border-gray-200">
            <CardContent className="p-0">
                <Table>
                    ...
                    <TableBody>
                        {brands.map((brand) => {
                            const collectionNames = brand.brandCollections
                                ?.map((bc) => bc.collection?.name)
                                ...
                                <TableRow key={brand.id} className="group">
                                    ...
                                    <TableCell className="text-center">
                                        {brand.brandCollections && brand.brandCollections.length > 0 ? (
                                            <span
                                                className="inline-flex cursor-pointer items-center gap-1 rounded-full bg-blue-50 px-2 py-0.5 text-xs font-medium text-blue-700"
