        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className="flex items-center gap-2 bg-[#FF5023] text-white px-4 py-2.5 rounded-xs hover:bg-[#E64519] transition-colors"
                >
                    {showNewUserForm ? (
                        <>
                            <X className="w-4 h-4" />
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 border border-gray-300 rounded-xs focus:ring-2 focus:ring-[#FF5023] focus:border-transparent"
                                placeholder="John"
                            />
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF5023] focus:border-transparent"
                                placeholder="Doe"
                            />
                        </div>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="w-full appearance-none px-4 py-2.5 pr-10 border border-gray-300 rounded-xs bg-white focus:ring-2 focus:ring-[#FF5023] focus:border-transparent cursor-pointer"
                            >
                            ...
                            <div className="flex items-start justify-between">
                                <div className="flex-1">
                                    <div className="flex items-center gap-3 mb-2">
                                        ...
                                        <span
                                            className={`text-xs px-2 py-1 rounded ${user.enabled
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div>
                                            ...
                                            <div className="relative">
                                                <select
                                                    ...
                                                    className="appearance-none px-3 py-1.5 pr-8 border border-gray-300 rounded-xs text-sm bg-white focus:ring-2 focus:ring-[#FF5023] focus:border-transparent cursor-pointer"
                                                >
                                        ...
                                        <div>
                                            ...
                                            <button
                                                ...
                                                className={`px-3 py-1.5 rounded-xs text-sm font-medium transition-colors ${user.enabled
