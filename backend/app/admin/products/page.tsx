...
export default function ProductsPage() {
    ...
    useEffect(() => {
        ...
        if (selectedCollection) {
            filtered = filtered.filter(product =>
                product.collections.some(pc => pc.collection.id === selectedCollection)
            );
        }
    ...
    const getProductPrice = (product: Product): string => {
        // If product has default pricing and no variants, show default price
        if (product.salePrice && product.variants.length === 0) {
        ...
        if (product.variants.length > 0) {
            ...
            if (minPrice === maxPrice) {
                return `KES ${formatPrice(minPrice)}`;
            } else {
                return `KES ${formatPrice(minPrice)} - ${formatPrice(maxPrice)}`;
            }
        }
                    ...
                    <div className="flex gap-4">
                        ...
                        >
                            ...
                            {activeFiltersCount > 0 && (
                                <span className="px-2 py-0.5 bg-[#FF5023] text-white text-xs rounded-full">
                                    {activeFiltersCount}
                                </span>
                            )}
                        </button>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            className="w-full px-3 py-2 border border-gray-300 rounded-xs focus:ring-2 focus:ring-[#FF5023] focus:border-transparent appearance-none"
                                        >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-3 py-2 border border-gray-300 rounded-xs focus:ring-2 focus:ring-[#FF5023] focus:border-transparent"
                                    />
                                </div>
                ...
                <div className="mb-6 flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xs transition-colors shadow-xs"
                        >
                        ...
                        <button
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-xs transition-colors shadow-xs"
                        >
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="text-sm text-gray-900">
                                                    {product.collections.length > 0
                                                        ? product.collections.map((pc) => pc.collection.name).join(', ')
                                                        : <span className="text-gray-400">None</span>
                                                    }
                                                </div>
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                {product.homepageCollections.length > 0 ? (
